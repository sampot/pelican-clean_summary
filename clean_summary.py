...
def init(pelican):
    ...
    global minimum_one
    global clean_target_tag
    global clean_target_class
    ...
    clean_target_tag = pelican.settings.get('CLEAN_SUMMARY_TARGET_TAG', None)
    clean_target_class = pelican.settings.get('CLEAN_SUMMARY_TARGET_CLASS', '')
